      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center py-16 md:py-24 lg:py-32">
            ...
            <div className="flex flex-col gap-8 md:gap-10 animate-fade-in-up">
              ...
              <p className="text-lg md:text-xl text-zinc-300 leading-relaxed max-w-md">
                Guarda, organiza y reutiliza todo lo que aprendes con la IA.
                Desde tus mejores prompts hasta comparaciones entre modelos,
                todo queda conectado para que nunca vuelvas a empezar desde
                cero.
              </p>
        ...
        <section className="py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-sm uppercase tracking-wider text-zinc-400 font-medium mb-8">
        ...
        >
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8 md:mb-12">
              ...
              <p className="text-zinc-400 text-center max-w-xl mx-auto mt-3 text-sm sm:text-base">
