...
export default function ArenaModal({
  ...
  return (
    ...
    >
      <div
        className="w-[calc(100%-2rem)] sm:w-full max-w-4xl rounded-xl bg-zinc-900 shadow-premium border border-zinc-800/40 my-8 max-h-[90dvh] overflow-y-auto animate-zoom-in flex flex-col"
      ...
      >
        ...
        {/* CONTENIDO */}
        <div className="px-5 sm:px-6 py-5 sm:py-7 space-y-6 sm:space-y-8 flex-1">
        ...
        {/* FOOTER */}
        <div className="sticky bottom-0 bg-zinc-900 px-5 sm:px-6 pb-5 sm:pb-6 pt-5 border-t border-zinc-800/30 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-3">
          <button
            type="button"
            onClick={onClose}
